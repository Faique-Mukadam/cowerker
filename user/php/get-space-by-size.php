...
// SELECT * FROM space WHERE space_type_id = 5 AND space_people_Qty BETWEEN 1 AND 4 AND space_status='available'
$sql = "SELECT * FROM space WHERE space_type_id = '" . $space_type_id . "' AND space_people_Qty BETWEEN 1 AND '" . $radioValue . "' AND  space_status='available' ORDER BY space_id DESC";
